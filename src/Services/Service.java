...
public class Service {
	...
	getAuthKey Obj2=new getAuthKey();
	...
	
	{
		...
		try {
			...
			requestSpecification.headers("authorization", "Bearer" + " " +Obj2.getauthkey());
			//System.out.println("********* AUTHKEY IS ***********");
		  //System.out.println(Obj2.getauthkey());
			//requestSpecification.headers("authorization", "Bearer 9181d77b-8ba5-4c90-88da-2c6c1bf53351");
